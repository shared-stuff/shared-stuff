...
cat $LIB/underscore.min.js $LIB/angular/angular.min.js $LIB/angular/angular-sanitize.min.js $LIB/bootstrap/js/bootstrap.min.js $LIB/remoteStorage.js >$TARGET/js/local-libs.min.js

echo "Combine javascripts..."
cat $LIB/jquery.min.js $LIB/underscore.min.js $LIB/angular/angular.min.js $LIB/angular/angular-sanitize.min.js $LIB/bootstrap/js/bootstrap.min.js $LIB/remoteStorage.js $TARGET/js/shared-stuff.min.js >$TARGET/js/shared-stuff-with-libs.min.js
